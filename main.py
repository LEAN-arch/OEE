...
if not logger.handlers:
    logging.basicConfig(level=logging.INFO,
                        ...
                        filemode='a')
logger.info("Main.py: Startup. Final attempt for light theme and syntax.", extra={'user_action': 'System Startup'})
                        ...
                        if plot_cfg_tab_item_final.get("is_spatial"):
                            ...
                            with st.container(border=True):
                                ...
                                with spatial_plot_cols_final[0]: 
                                    ...
                                    if max_mins_ui_main_app_val < active_mpi_main_app_val : # Check if overall time range is too small
                                        st.caption("Not enough data for time step snapshot selector.")
                                        snap_step_val_final_widget_val = min_s_val_slider # Default value if slider not shown
                                    else:
