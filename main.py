...
def render_settings_sidebar():
    with st.sidebar:
        ...
        st.markdown("<h1 style='text-align: center; margin-bottom: 1.5rem; color: #A0A0A0;'>LEAN 2.0 Institute</h1>", unsafe_allow_html=True) # ADDED LEGEND
...
def main():
    ...
    with tabs[2]: 
        ...
        if st.session_state.simulation_results:
            ...
            with st.container(border=True): # Grouping insights in a container
            ...
            st.markdown("---"); st.subheader("Spatial Dynamics Analysis") # Moved to be always visible, not in expander
            with st.container(border=True):
